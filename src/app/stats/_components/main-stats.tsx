...
export function calculateTimeSpentWatching(time: number | undefined) {
  if (time && time > 60) {
      ...
      <ul className="w-full flex flex-row justify-center items-start gap-3 pb-0.5">
        <li className="flex flex-col justify-center items-start gap-0.5 text-xs bg-muted px-2 pb-1.5 pt-0.5 rounded-md pointer-events-none select-none">
          <label className="font-semibold underline flex flex-row gap-1">
            Folders <FolderIcon className="w-2.5 h-auto" />
          </label>
          <span className="font-medium bg-accent rounded-sm px-0.5">{mainStats?.total_manga}</span>
        </li>
        <Separator className="min-w-[1.5px] max-w-[1.9px] h-11" />
        <li className="flex flex-col justify-center items-start gap-0.5 text-xs bg-muted px-2 pb-1.5 pt-0.5 rounded-md pointer-events-none select-none">
          <label className="font-semibold underline flex flex-row gap-1">
            Panels <VideoCameraIcon className="w-3 h-auto" />
          </label>
          <span className="font-medium bg-accent rounded-sm px-0.5">{mainStats?.total_panels}</span>
        </li>
        <Separator className="min-w-[1.9px] max-w-[2.05px] h-11" />
        <li className="flex flex-col justify-center items-start gap-0.5 text-xs bg-muted px-2 pb-1.5 pt-0.5 rounded-md pointer-events-none select-none">
          <label className="font-semibold underline flex flex-row gap-1">
            Read <EyeIcon className="w-3 h-auto" />
          </label>
          <span className="font-medium bg-accent rounded-sm px-0.5">{mainStats?.total_panels_read}</span>
        </li>
        <Separator className="min-w-[2.1px] max-w-[2px] h-11" />
        <li className="flex flex-col justify-center items-start gap-0.5 text-xs bg-muted px-2 pb-1.5 pt-0.5 rounded-md pointer-events-none select-none">
          <label className="font-semibold underline flex flex-row gap-1">
            Remaining <EyeSlashIcon className="w-3 h-auto" />{" "}
          </label>
          <span className="font-medium bg-accent rounded-sm px-0.5">{mainStats?.total_panels_remaining}</span>
        </li>
        <Separator className="min-w-[2.1px] max-w-[2px] h-11" />
        <li className="flex flex-col justify-center items-start gap-0.5 text-xs bg-muted px-2 pb-1.5 pt-0.5 rounded-md pointer-events-none select-none">
          <label className="font-semibold underline flex flex-row gap-1">
            Time Spent Reading <ClockIcon className="w-3 h-auto" />
          </label>
          <span className="font-medium bg-accent rounded-sm px-0.5">{calculateTimeSpentWatching(mainStats?.total_time_spent_reading)}</span>
        </li>
      </ul>
    </div>
  );
